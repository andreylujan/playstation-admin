...
.controller('NewPromotionCtrl', function($scope, $filter, $log, $window, $moment, $modal, $stateParams, $state, ngTableParams, Zones, Dealers, Users, Promotions, Validators) {
...
.controller('MessageModalInstance', function($scope, $log, $modalInstance, title) {
